...
(function ($) {
  $.widget("custom.phonecode", {
    ...
    _create: function () {
      ...
      var selector = $(
        '<div class="country-phone-selector"><div class="country-phone-selected"></div><div class="country-phone-options"></div></div>'
      );
    ...
    _initSelector: function () {
      ...
      var self = this;
      var searchInput = $(
        '<input type="text" class="country-phone-search" value="">'
      );
      $(searchInput).appendTo(options);
      var searchLabel = $(
        '<label class="country-phone-search-label">Введите страну</label>'
      );
      $(searchLabel)
        .on("click", function () {
          $(this).hide();
